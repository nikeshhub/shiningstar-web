...
export const dashboardRouteDefinitions = [
  ...
  { path: 'exams/add', element: ExamForm, allowedRoles: ['Admin'], title: 'Add Exam' },
  { path: 'exams/edit/:id', element: ExamForm, allowedRoles: ['Admin'], title: 'Edit Exam' },
  { path: 'exams/:id/marks', element: MarksEntry, allowedRoles: ['Admin', 'Teacher'], title: 'Marks Entry' },
