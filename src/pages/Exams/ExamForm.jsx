    ...
    try {
      ...
      if (response.data.success) {
        ...
        setFormData({
          ...
          startDate: adToBSDate(exam.startDate),
          endDate: adToBSDate(exam.endDate),
          status: exam.status,
          routine: (exam.routine || []).map((entry) => ({
            ...entry,
            class: entry.class?._id || entry.class,
            subject: entry.subject?._id || entry.subject,
            examDate: adToBSDate(entry.examDate),
          })),
            ...
            <Grid container spacing={3}>
              ...
              <Grid size={{ xs: 12, md: 6 }}>
                <Select
                  ...
                  allowNone={false}
                  helperText="Terminal 1-4. Fees for 3 months of tuition will be auto-charged to each family on creation."
                />
              </Grid>
