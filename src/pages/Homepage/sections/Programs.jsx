  ...
  const programs = [
    {
      ...
      description: 'Foundation years focused on play-based learning, social skills, and early literacy development in a nurturing environment.',
    ...
    },
    {
      ...
      title: 'Primary',
      subtitle: 'Class 1-5',
      description: 'Building strong academic fundamentals with emphasis on English, Math, Science, and creative expression through interactive learning.',
      ...
      <div className="programs__container">
        <div className="programs__header">
          ...
          <p className="programs__intro">
            Comprehensive educational journey from early childhood to lower secondary level
          </p>
        </div>
        ...
        <div className="programs__cta">
          <Button variant="primary" size="large">View All Programs</Button>
        </div>
      </div>
    </section>
  );
